...
if(istable(weapons.Get('weapon_xdefm_rod')))then
  ...
  Weapons[#Weapons+1]={description="TRADE!",Model="models/weapons/w_suitcase_passenger.mdl",Group=2,Class="weapon_xdefm_trade",Name="Fishing Trace",Price=-10,Ammo=0,AmmoClass="",Damage=0}
end
end)
